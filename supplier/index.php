...
<div class="sidebar">
    ...
    <a href="index.php" class="active"><i class="fa-solid fa-truck"></i> Supplier</a>
...
<div class="content">
    <h3><i class="fa-solid fa-truck"></i> Data Supplier</h3>

    <div class="card">
        <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:20px;">
            <h4>List Supplier</h4>
            <a href="tambah.php" class="btn btn-primary"><i class="fa-solid fa-plus"></i> Tambah Supplier</a>
        </div>
        ...
        <div class="table-responsive">
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <td><?=$no++?></td>
                        <td><strong><?=$d['nama_supplier']?></strong></td>
                        <td><?=$d['telp']?></td>
                        <td><?=$d['alamat']?></td>
                        <td>
