...
<div class="content">
    <h3><i class="fa-solid fa-box-open"></i> Input Barang Masuk</h3>

    <div class="grid" style="grid-template-columns: 1fr 2fr;">
        <div class="card" style="text-align:center;">
            <h4>Scan QR Barang</h4>
            <video id="preview"></video>
            <p style="font-size:12px;">Arahkan kamera ke QR Code barang</p>
        </div>
        ...
        <div class="card">
            ...
            <form method="POST" action="proses.php">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="qty" placeholder="Jumlah Barang" required>
                    <input type="date" name="tanggal" required>
                </div>

                <button class="btn btn-primary" style="width:100%"><i class="fa-solid fa-save"></i> Simpan Transaksi</button>
            </form>
        </div>
    </div>
</div>
